...
export function Avatar({
	...
	// "me" resolves per phone: Melissa on the guest side, Ryan on the host.
	const self = React.useContext(SelfAvatarContext);
	const v = variant === 'me' ? self : variant;
	const Face = FACE_AVATARS[v];
	if (Face) {
		return (
